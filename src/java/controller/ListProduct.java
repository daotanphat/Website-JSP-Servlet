...
//            if (categoryId == 1) {
//                list = dao.detailStove(null, null);
//            } else if (categoryId == 2) {
//                list = dao.detailExtractor(null, null);
//            } else if (categoryId == 3) {
//                list = dao.detailBlender(null, null);
//            } else if (categoryId == 4) {
//                list = dao.detailMicrowave(null, null);
//            } else if (categoryId == 5) {
//                list = dao.detailRefrigerator(null, null);
//            } else if (categoryId == 6) {
//                list = dao.detailWaterPurifier(null, null);
//            }
            // get all product
            list = dao.displayProduct(categoryId);
            ...
            request.setAttribute("urlpattern", "list-product");
